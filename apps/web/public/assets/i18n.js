...
(function () {
  ...
  const builtinDictionaries = {
    de: {
      ...
      'landing.lock.label': 'Beim Erstellen sperren (nur du kannst entsperren)',
      ...
      'owner.welcome.title': 'Du bist Owner dieses Spaces',
      'owner.welcome.warning': 'Die aktuelle Browser-URL enthält deinen Owner-Link – bewahre sie wie ein Passwort auf. Geht der Owner-Link verloren, bleibt der Space dauerhaft gesperrt.',
      'owner.welcome.shareLabel': 'Teilen-Link (nur Lesen)',
      'owner.welcome.copy': 'Link kopieren',
      'owner.welcome.dismiss': 'Verstanden',
    ...
    en: {
      ...
      'landing.lock.label': 'Lock on create (only you can unlock)',
      ...
      'owner.welcome.title': 'You are the owner of this space',
      'owner.welcome.warning': 'The current browser URL contains your owner link – treat it like a password. If you lose the owner link, the space stays locked forever.',
      'owner.welcome.shareLabel': 'Share link (read-only)',
      'owner.welcome.copy': 'Copy link',
      'owner.welcome.dismiss': 'Got it',
