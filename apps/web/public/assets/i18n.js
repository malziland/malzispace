...
(function () {
  ...
  const builtinDictionaries = {
    de: {
      ...
      'space.heading': 'malziSPACE Editor',
      'space.presence.aria': 'Anwesende Personen',
      'space.toolbar.aria': 'Space-Aktionen',
    ...
    en: {
      ...
      'space.heading': 'malziSPACE editor',
      'space.presence.aria': 'People present',
      'space.toolbar.aria': 'Space actions',
