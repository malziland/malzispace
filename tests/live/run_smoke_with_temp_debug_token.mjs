...
const FIREBASE_API_KEY = process.env.FIREBASE_API_KEY || 'AIzaSyBp1aHB6bfr28Fyos3Z6Y5HzWh7ki_DW0U';
const PROJECT_ID = process.env.FIREBASE_PROJECT_ID || 'malzispace';
const PROJECT_NUMBER = process.env.FIREBASE_PROJECT_NUMBER || '457350771644';
const APP_ID = process.env.FIREBASE_APP_ID || '1:457350771644:web:1bfe76d93b81e9316ab1b9';
