...
- `prototype-append-only.html` aus dem ausgelieferten Verzeichnis entfernt. Der
  UI-Entwurf vom Mai lag untracked in `apps/web/public/` und war dadurch seit
  Mai oeffentlich erreichbar (HTTP 200), obwohl das Feature seit 1.3.0 released
  ist. Live jetzt 404.

### Changed
- **Repo-Hygiene-Check bricht jetzt bei jeder ungetrackten Datei unter
  ...
  bleibt fuer Review, A11y-Gate und CI unsichtbar. Mit Positiv- und
  Negativprobe verifiziert.
