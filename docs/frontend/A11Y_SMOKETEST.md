...
| 2026-07-16 | VoiceOver pass (macOS, `Cmd+F5`) over landing + editor | **deliberately skipped** (maintainer decision) — accepted because the axe gate already verifies the screen-reader-relevant semantics (roles, names, labels) and keyboard paths are proven; revisit before a major UI redesign |
